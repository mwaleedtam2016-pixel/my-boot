...
- يمكن للمالك أو الأدمن تحديد حتى 5 قنوات باستخدام /abb-channel أو abb-channel مع منشن القنوات.
...
- أمر يومي أو /daily يمنح مكافأة كل 24 ساعة، وتزداد المكافأة مع سلسلة الأيام المتتالية.
...
- أمر رصيد أو /balance يعرض رصيد محفظتك، البنك، وإجمالي الرصيد لك أو لأي عضو تحدده.
- أمر تحويل @الشخص [المبلغ] أو /transfer يقوم بتحويل الأموال من محفظتك إلى محفظة عضو آخر.
